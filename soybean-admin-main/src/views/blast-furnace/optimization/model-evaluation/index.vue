<template>
  <div class="model-evaluation w-full p-4 md:p-6 box-border">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-4">
      <n-card title="评估配置" class="xl:col-span-2 border shadow-sm">
        <n-form label-placement="left" label-width="100">
          ...
          <div class="flex justify-end gap-2">
            <n-button type="primary" @click="startEvaluation" :loading="evaluating">
              开始评估
            </n-button>
            <n-button @click="resetEvaluation">重置</n-button>
          </div>
        </n-form>
      </n-card>

      <n-card title="模型简述" class="border shadow-sm">
    ...
    <n-card title="评估结果" class="mb-4 border shadow-sm">
      <n-tabs type="line" animated v-model:value="activeTab">
        <n-tab-pane name="metrics" tab="核心指标">
          <div class="py-4">
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              <n-card size="small" :bordered="true" class="text-center border shadow-sm">
        ...
        <n-tab-pane name="analysis" tab="结果分析" display-directive="show">
          <div class="py-4 grid grid-cols-1 xl:grid-cols-2 gap-4">
            <n-card title="预测值 vs 实际值" size="small" class="border shadow-sm">
            ...
            <n-card title="误差分布分析" size="small" class="border shadow-sm">
              <div class="h-[400px] relative">
                <div
                  v-if="evaluating"
                  class="absolute inset-0 z-10 flex items-center justify-center transition-colors duration-300"
            ...
            <n-card
              title="特征重要性"
              size="small"
              class="xl:col-span-2 border shadow-sm"
            >
              <div class="h-[400px] relative">
                <div
                  v-if="evaluating"
...
<script setup lang="ts">
  ...
  const evaluationHistoryColumns: DataTableColumns<any> = [
    { type: 'selection' },
    {
      title: '序号',
      key: 'index',
