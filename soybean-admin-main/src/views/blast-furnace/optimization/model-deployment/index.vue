<template>
  <div
    class="model-deployment w-full p-4 md:p-6 box-border"
  >
    <n-card title="模型部署" class="mb-4 border">
      <!-- 部署配置 -->
      <n-form label-placement="left" label-width="120" class="mb-4">
        ...
        <div class="flex justify-end">
          <n-button type="primary" @click="deployModel">部署模型</n-button>
          <n-button @click="resetDeployment" class="ml-2">重置</n-button>
        </div>
      </n-form>
      ...
      <n-tabs v-model:value="activeTab" type="line">
        <n-tab-pane name="status" tab="部署状态">
          <div class="p-4 rounded-lg border" style="background-color: var(--n-color); border-color: var(--n-border-color);">
            <n-card title="当前部署状态" size="small" class="mb-4 border">
            ...
            <n-card title="部署日志" size="small" class="border">
        ...
        <n-tab-pane name="history" tab="部署历史">
          <div class="p-4 rounded-lg border" style="background-color: var(--n-color); border-color: var(--n-border-color);">
            <div class="rounded-lg border p-4" style="background-color: var(--n-color); border-color: var(--n-border-color);">
              <div class="flex flex-wrap items-center gap-3 mb-3">
                ...
                <n-select
                  ...
                  clearable
                />
                <n-button type="primary" ghost size="small" @click="loadDeploymentHistory">
                  刷新
                </n-button>
                <div class="flex items-center gap-2">
        ...
        <n-tab-pane name="service" tab="服务管理">
          <div class="p-4 rounded-lg border" style="background-color: var(--n-color); border-color: var(--n-border-color);">
            <div class="flex flex-col xl:flex-row gap-4 min-h-[520px]">
              <n-card title="服务列表" size="small" class="w-full xl:w-2/5 xl:h-full border">
              ...
              <n-card title="服务控制台" size="small" class="w-full xl:w-3/5 xl:h-full border">
                <div class="flex flex-col gap-4 h-full">
                  ...
                  <div class="rounded-lg border p-4" style="border-color: var(--n-border-color);">
        ...
        <n-tab-pane name="onlinePredict" tab="在线预测">
          <div class="p-4 rounded-lg border" style="background-color: var(--n-color); border-color: var(--n-border-color);">
            <n-card title="在线预测控制台" size="small" class="border">
              <div class="rounded-lg border p-4" style="background-color: var(--n-color); border-color: var(--n-border-color);">
              ...
              <div class="mt-4 rounded-lg border p-4" style="border-color: var(--n-border-color);">
                <n-form label-placement="left" label-width="120">
                  ...
                  >
                    <div class="text-xs" style="color: var(--n-text-color-1);">
                  ...
                  <div class="mt-2 flex flex-wrap justify-end gap-2">
                    <n-button @click="resetPredictionInput">重置输入</n-button>
                    <n-button type="primary" @click="testService">测试服务</n-button>
                    <n-button :loading="explainLoading" @click="explainService">
                      解释性分析
                    </n-button>
                  </div>
                </n-form>
...
<script setup lang="ts">
  ...
  const deploymentHistoryColumns = computed<DataTableColumns<any>>(() => [
  ...
  const serviceColumns: DataTableColumns<any> = [
    {
      title: '服务ID',
      key: 'id',
      width: 120,
  ...
  const explainImportanceColumns: DataTableColumns<any> = [
  ...
  const explainSensitivityColumns: DataTableColumns<any> = [
