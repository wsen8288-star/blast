<template>
  <div class="h-full p-4">
    ...
    <n-card title="模拟数据质量看板" size="small" class="mb-4">
      <div class="flex items-center gap-3">
        ...
        <n-button type="primary" @click="loadMetrics" :loading="loading">刷新指标</n-button>
      </div>
    </n-card>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
      <n-card v-for="item in metricCards" :key="item.key" size="small">
