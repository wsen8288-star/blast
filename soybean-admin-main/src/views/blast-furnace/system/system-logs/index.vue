<template>
  <div class="w-full text-[#CBD5E1] p-4 md:p-6 box-border space-y-4">
    <n-card :bordered="false" size="small" class="border">
      <div class="flex items-start justify-between">
        <div>
          <div class="text-base font-semibold text-[#F1F5F9]">系统日志</div>
          <div class="mt-1 text-xs text-[#94A3B8]">异常请求日志与用户操作审计日志查询</div>
        </div>
    ...
    <n-card :bordered="false" size="small" class="border text-[#F1F5F9]">
      <div class="flex flex-wrap items-center gap-3">
        ...
        <div class="flex items-center gap-2">
          <n-button size="small" type="primary" :loading="loading" @click="search">查询</n-button>
