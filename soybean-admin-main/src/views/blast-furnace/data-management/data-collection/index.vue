<template>
  <div
    class="data-collection w-full p-4 md:p-6 box-border"
  >
    <n-card title="数据采集" class="mb-4 border">
        ...
        <n-tab-pane name="realtime" tab="实时采集">
          <div class="p-4 rounded-lg border" style="background-color: var(--n-color); border-color: var(--n-border-color);">
            <div class="flex items-center justify-between mb-4">
              ...
              <div>
                <n-button :disabled="connectionStatus !== 'connected'" @click="startCollection"
                  >开始采集</n-button
                >
                <n-button
            ...
            <n-card title="采集设备列表" size="small" class="mb-4 border">
              <n-data-table :columns="deviceColumns" :data="deviceList" size="small" />
            </n-card>

            <n-card title="采集参数设置" size="small" class="border">
          ...
          <div class="p-4 rounded-lg border" style="background-color: var(--n-color); border-color: var(--n-border-color);">
            <div class="flex items-center mb-4">
              ...
              <n-date-picker
                ...
                class="mr-2"
              />
              <n-button type="primary" @click="searchHistory">搜索</n-button>
              <n-button @click="resetHistorySearch" class="ml-2">重置</n-button>
            </div>
