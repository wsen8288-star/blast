...
export function useECharts(
  ...
  function normalizeEChartsTheme(t: 'light' | 'dark' | 'default') {
  ...
  function initCharts(t = theme) {
    ...
    chartInstance = echarts.init(el, normalizeEChartsTheme(t));
  ...
  function setOptions(options: EChartsOption, clear = true) {
    ...
    nextTick(() => {
      useTimeoutFn(() => {
        if (!chartInstance) {
          initCharts(getDarkTheme.value as 'light' | 'dark' | 'default');
  ...
  watch(
    ...
    (theme) => {
      if (chartInstance) {
        ...
        initCharts(theme as 'light' | 'dark' | 'default');
