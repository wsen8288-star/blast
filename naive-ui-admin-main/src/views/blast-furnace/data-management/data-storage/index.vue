<template>
  <div class="data-storage min-h-[calc(100vh-80px)] w-full flex-1  p-4 md:p-6 overflow-auto box-border">
    <n-card title="数据存储" class="mb-4 storage-main-card">
      <n-tabs type="line" default-value="status">
        <n-tab-pane name="status" tab="存储状态">
          <div class="storage-panel">
            <div class="grid grid-cols-2 gap-4 mb-4">
              <n-card size="small" class="storage-sub-card">
            ...
            <n-card title="存储设备状态" size="small" class="mb-4 storage-sub-card">
              <div>
                <p>存储设备列表：</p>
        ...
        <n-tab-pane name="configuration" tab="存储配置">
          <div class="storage-panel">
            <n-card title="存储路径设置" size="small" class="mb-4 storage-sub-card">
              <n-form label-placement="left" label-width="150" class="storage-form">
                ...
                <n-form-item>
                  <n-button round type="primary" @click="saveStorageConfig">保存配置</n-button>
                  <n-button round @click="resetStorageConfig" class="ml-2">重置配置</n-button>
                </n-form-item>
              </n-form>
            </n-card>
          </div>
        ...
        <n-tab-pane name="backup" tab="数据备份">
          <div class="storage-panel">
            <div class="flex items-center justify-between mb-4">
              ...
              <n-button round type="primary" @click="startManualBackup">手动备份</n-button>
            </div>

            <n-card title="备份历史" size="small" class="mb-4 storage-sub-card">
              <n-data-table
            ...
            <n-card title="备份恢复" size="small" class="storage-sub-card">
              <div class="flex items-center mb-4">
                <n-select
                  ...
                  class="mr-2"
                />
                <n-button round type="error" @click="restoreFromBackup">恢复数据</n-button>
              </div>
...
<style scoped>
  ...
  .storage-form :deep(.n-base-selection),
  .storage-form :deep(.n-input),
  .storage-form :deep(.n-input-number) {
    border-radius: 10px;
  }
</style>
